...
const categories = [
    ...
    { title: 'Formal', image: 'https://images.unsplash.com/photo-1593030761757-71fae45fa0e7?q=80&w=2080&auto=format&fit=crop', className: 'card-large' },
    ...
    return (
        <section className="style-categories">
            <div className="container style-container">
                <h2 className="section-title-alt">BROWSE BY STYLE</h2>
